...
import { ModelSelection, ProjectIconMetadata, ProjectScript } from "@jcode/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.iconMetadata != null ? JSON.stringify(row.iconMetadata) : null},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.deletedAt}
        )
        ...
        DO UPDATE SET
          ...
          icon_metadata_json = excluded.icon_metadata_json,
