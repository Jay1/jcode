...
function withFakeCodexEnv<A, E, R>(
  ...
  return Effect.acquireUseRelease(
    Effect.gen(function* () {
      ...
      const previousDisableBrowserPlugin = process.env.JCODE_DISABLE_CODEX_BROWSER_PLUGIN;
    ...
    (previous) =>
      Effect.sync(() => {
        ...
        if (previous.previousDisableBrowserPlugin === undefined) {
          ...
          process.env.JCODE_DISABLE_CODEX_BROWSER_PLUGIN = previous.previousDisableBrowserPlugin;
        }
