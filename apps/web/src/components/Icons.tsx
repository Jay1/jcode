...
// Sourced from central-icons-reversed/dot-grid-2x3.svg for drag handles.
export const DotGrid2x3Icon: Icon = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <g>
      <path
        d="M7.5 5.75C7.5 4.78 8.28 4 9.25 4C10.22 4 11 4.78 11 5.75C11 6.72 10.22 7.5 9.25 7.5C8.28 7.5 7.5 6.72 7.5 5.75Z"
        fill="currentColor"
      />
      <path
        d="M13 5.75C13 4.78 13.78 4 14.75 4C15.72 4 16.5 4.78 16.5 5.75C16.5 6.72 15.72 7.5 14.75 7.5C13.78 7.5 13 6.72 13 5.75Z"
        fill="currentColor"
      />
      <path
        d="M7.5 18.25C7.5 17.28 8.28 16.5 9.25 16.5C10.22 16.5 11 17.28 11 18.25C11 19.22 10.22 20 9.25 20C8.28 20 7.5 19.22 7.5 18.25Z"
        fill="currentColor"
      />
      <path
        d="M13 18.25C13 17.28 13.78 16.5 14.75 16.5C15.72 16.5 16.5 17.28 16.5 18.25C16.5 19.22 15.72 20 14.75 20C13.78 20 13 19.22 13 18.25Z"
        fill="currentColor"
      />
      <path
        d="M7.5 11.9C7.5 10.93 8.28 10.15 9.25 10.15C10.22 10.15 11 10.93 11 11.9V12C11 12.97 10.22 13.75 9.25 13.75C8.28 13.75 7.5 12.97 7.5 12V11.9Z"
        fill="currentColor"
      />
      <path
        d="M13 11.9C13 10.93 13.78 10.15 14.75 10.15C15.72 10.15 16.5 10.93 16.5 11.9V12C16.5 12.97 15.72 13.75 14.75 13.75C13.78 13.75 13 12.97 13 12V11.9Z"
        fill="currentColor"
      />
    </g>
  </svg>
...
export const KiloIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fill="currentColor"
      d="M0 0v100h100V0H0Zm92.59 92.59H7.41V7.41h85.19v85.19ZM61.11 71.91h9.26v7.41H58.73l-5.03-5.03V62.65h7.41v9.26ZM77.78 71.91h-7.41v-9.26h-9.26v-7.41h11.64l5.03 5.03v11.64ZM46.3 61.11h-7.41V53.7h7.41v7.41ZM22.22 53.7h7.41v16.67H46.3v7.41H27.25l-5.03-5.03V53.7ZM77.78 38.89V46.3H53.7v-7.41h8.28v-9.26H53.7v-7.41h10.66l5.03 5.03v11.64h8.39ZM29.63 30.56h9.26l7.41 7.41v8.33h-7.41v-8.34h-9.26v8.33h-7.41V22.22h7.41v8.34ZM46.3 30.56h-7.41v-8.34h7.41v8.34Z"
    />
  </svg>
);
