...
import { type MessageId, type ThreadId, type TurnId } from "@jcode/contracts";
        ...
        {scrollButtonVisible ? (
          <div className="pointer-events-none absolute bottom-1 left-1/2 z-30 flex -translate-x-1/2 justify-center py-1">
            <button
              ...
              className="pointer-events-auto flex size-9 items-center justify-center rounded-full border border-[color:var(--app-scroll-button-border)] bg-[var(--app-scroll-button-bg)] text-[var(--app-scroll-button-fg)] shadow-sm backdrop-blur-sm transition-colors hover:cursor-pointer hover:bg-[var(--app-scroll-button-hover-bg)] hover:text-[var(--app-scroll-button-hover-fg)]"
            >
