...
function resolveToastSurfaceClass(type: ToastObject<ThreadToastData>["type"]): string {
  if (type === "error") {
    return "border-[color:var(--app-status-error-border)] bg-[var(--app-status-error-bg)]";
  }

  if (type === "warning") {
    return "border-[color:var(--app-status-warning-border)] bg-[var(--app-status-warning-bg)]";
  }

  return "border-[color:var(--color-border-light)] bg-[var(--app-surface-card)]";
}
