            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                const stashConflictToastId = addBranchRecoveryToast({
                  ...
                  description:
                    "JCode switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",
        ...
        <DialogPopup className="max-w-xl">
          ...
          <DialogPanel className="space-y-4">
            {stashDiscardDialog?.loading ? (
              <p className="text-muted-foreground text-sm">Loading stash details&hellip;</p>
