...
describe("derivePendingUserInputs", () => {
  ...
  it("clears stale pending user-input prompts when Codex omits the hyphen", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
      ...
      makeActivity({
        ...
        payload: {
          requestId: "req-user-input-codex-stale-1",
          detail: "Unknown pending codex user input request: req-user-input-codex-stale-1",
        },
      }),
    ];
...
describe("PROVIDER_OPTIONS", () => {
  it("lists available providers", () => {
    ...
    const openclaw = PROVIDER_OPTIONS.find((option) => option.value === "openclaw");
