...
const MODE_ARGS = {
  dev: [
    ...
    "dev",
    "--ui=tui",
    "--filter=@jcode/contracts",
    "--filter=@jcode/web",
    "--filter=@jcode/server",
    "--parallel",
  ],
  "dev:server": ["run", "dev", "--filter=@jcode/server"],
  "dev:web": ["run", "dev", "--filter=@jcode/web"],
  "dev:desktop": ["run", "dev", "--filter=@jcode/desktop", "--filter=@jcode/web", "--parallel"],
