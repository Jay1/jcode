...
1. Publish a GitHub Release with the Windows installer asset, for example `JCode-0.0.48-x64.exe`.
2. Compute the installer SHA256 with `sha256sum JCode-0.0.48-x64.exe` or `Get-FileHash -Algorithm SHA256`.
