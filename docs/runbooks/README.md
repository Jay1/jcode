...
| Running local deployment                       | [Local Deploy Notes](local-deploy.md)                       | [Local OpenCode Runtime Service](local-opencode-runtime.md)                      |
| Inspecting local runtime services              | [Local OpenCode Runtime Service](local-opencode-runtime.md) | [Local Deploy Notes](local-deploy.md)                                            |
...
| Updating Jay's local stable JCode              | [Update Local Stable JCode](update-local-stable-jcode.md)   | [Local OpenCode Runtime Service](local-opencode-runtime.md)                      |
...
- [Local OpenCode Runtime Service](local-opencode-runtime.md)
